...
fun main() {
    ...
    println("The movie ticket price for a person aged $adult \$${ticketPrice(adult, isMonday)}.")
    println("The movie ticket price for a person aged $senior \$${ticketPrice(senior, isMonday)}.")
}
